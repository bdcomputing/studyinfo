                                ...
                                <div class="flex p-5  justify-between w-full  ">
                                    ...
                                    <div>
                                        <input type="search" name="" placeholder="search"
                                            class=" border-gray-200 py-1.5 focus:border-gray-400 rounded-xl placeholder:text-gray-400"
                                            id="">
                                    </div>
                                    <a href="{{ route('admin.universities.create') }}"
                                        class="rounded-lg cursor-pointer bg-primary self-end text-white  px-3 py-1.5">Add
                                        University</a>
                                </div>
                            </div>
                                    ...
                                    <tr>
                                            ...
                                            <div class="inline-flex items-center gap-x-3">
                                                ...
                                                <div class="flex items-center gap-x-2">
                                                    <img class="object-cover w-10 h-10 rounded-full"
                                                        src="{{ $university->logo_url }}" alt="{{ $university->name }}">
                                        ...
                                        <td class="px-12 py-4 text-sm font-medium text-gray-700 whitespace-nowrap">
                                            <div class="inline-flex items-center px-3 py-1">
                                                ...
                                                <h2 class="text-sm font-normal text-gray-600">{{ $university->name }}
                                                </h2>
                                            </div>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <h2 class="text-sm font-normal text-gray-600">
                                                {{ $university->destination->name }}</h2>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap ">
                                            <p class="flex items-center text-gray-600">{{ $university->tuition_fee }}
                                                <span
                                                    class="pl-2 text-sm text-primary rounded-lg font-bold">{{ $university->destination->currency }}</span>
                                            </p>
                                        </td>
                                ...
                                @empty<tr>
                                        <td colspan="20">
                                            <div class="flex flex-col w-full max-w-sm px-4 mx-auto">
                                                ...
                                                <h1 class="mt-3 text-lg text-gray-800 text-center ">No University found
                                                </h1>
