        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white  overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-primary ">
                    <div class="py-5">
                        <p class="text-lg md:text-xl">Add Scholarship</p>
                    </div>
                    <form id="form" action="{{ route('admin.scholarships.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf

                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 pb-5">
                            <div class="">
                                <label for="name"
                                    class="block text-sm font-medium text-gray-700 ">Scholarship Name <span class="text-red-500">*</span></label>
                            ...
                            <div class="">
                                ...
                                <input type="number" name="amount" id="title" value="{{ old('amount') }}" required
                                    class="mt-1 block w-full rounded-md border-gray-300    shadow-sm focus:border-primary focus:ring-primary">
                                @error('amount')
                                <p class="mt-1 text-sm text-red-600 ">{{ $message }}</p>
                                @enderror
                            ...
                            <div class="col-span-2">
                                ...
                                <textarea name="description" id="description" rows="3" required
                                    class="mt-1 editor block w-full rounded-md border-gray-300    shadow-sm focus:border-primary focus:ring-primary">{{ old('description') }}</textarea>
                            ...
                            <div class="col-span-2">
                                ...
                                <textarea name="eligibility_criteria" id="eligibility_criteria" rows="3" required
                                    class="mt-1 editor block w-full rounded-md border-gray-300    shadow-sm focus:border-primary focus:ring-primary">{{ old('eligibility_criteria') }}</textarea>
