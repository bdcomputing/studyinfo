                    ...
                    <div class="flex justify-between items-center mb-6">
                        ...
                        <div class="flex space-x-4">
                            ...
                            <a href="{{ route('admin.blog.edit', $blog) }}"
                                class="px-6 py-1.5 rounded-lg bg-primary text-white  hover:bg-primary-900 transition">
                                Edit
                            </a>
                            <a href="{{ route('admin.blog') }}"
                                class="px-4 py-1.5 rounded-lg bg-gray-500 text-white  hover:bg-gray-600 transition">
                                Back to List
                            </a>
                        </div>
                    </div>
