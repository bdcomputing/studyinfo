                        ...
                        <div class="md:grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="">
                                <label for="continent_id"
                                    class="block text-sm font-medium text-gray-700 ">Continent<span
                                        class="text-red-500">*</span></label>
                                <select name="continent_id" class="rounded-md border-gray-600">
                                    ...
                                    @forelse($continents as $continent)
                                        <option {{ $destination->continent_id === $continent->id ? 'selected' : '' }}
                            ...
                            <div class="">
                                <label for="currency" class="block text-sm font-medium text-gray-700 required">Currency
                                    <span class="text-red-500">*</span></label>
                                <input type="text" name="currency" id="title"
                                    value="{{ old('currency', $destination->currency) }}" required
                                    class="mt-1 block w-full rounded-md border-gray-300    shadow-sm focus:border-primary-500 focus:ring-primary-500">
                                @error('currency')
                                    <p class="mt-1 text-sm text-red-600 ">{{ $message }}</p>
                                @enderror
                            ...
                            <div>
                                <label for="cost_of_living" class="block text-sm font-medium text-gray-700 ">Average
                                    ...
                                    <div class="space-y-1 text-center">
                                        <div class="flex items-center gap-4">
                                            <img src="{{ $destination->image_url }}"
                                                class="object-cover size-20 rounded-md" alt="">
                            ...
                            <div class="">
                                ...
                                <div
                                    ...
                                    <div class="space-y-1 text-center">
                                        <div class="flex items-center gap-4">
                                            <img src="{{ $destination->flag_url }}"
                                                class="size-20 object-cover rounded-md" alt="">
                            ...
                            <div class="col-span-2">
                                <div class="flex items-start">
                                    ...
                                    <div class="ml-3 text-sm">
                                        <label for="is_popular" class="font-medium text-gray-700 ">Is Destination
                                            Popolar</label>
                                    </div>
                                </div>
