                ...
                <div class="p-6">
                    <div class="flex justify-between items-center mb-6">
                        ...
                        <div class="flex space-x-4">
                            ...
                            <form action="{{ route('admin.blog.update', $destination) }}" method="POST">
                                @csrf
                                @method('PUT')
                                <input type="hidden" name="title" value="{{ $destination->title }}">
                                <input type="hidden" name="description" value="{{ $destination->description }}">
                                <input type="hidden" name="content" value="{{ $destination->content }}">
                                <input type="hidden" name="category" value="{{ $destination->category }}">
                                <input type="hidden" name="publish_date" value="{{ $destination->publish_date }}">
