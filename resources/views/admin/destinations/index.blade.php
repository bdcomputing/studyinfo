                ...
                <div class="md:py-5 ">
                    <div class="flex p-5  justify-between w-full  ">
                        ...
                        <a href="{{ route('admin.destinations.create') }}"
                            class="rounded-lg cursor-pointer bg-primary self-end text-white  px-3 py-1.5">New
                            Destination</a>
                    </div>
                                    ...
                                    <tr>
                                        ...
                                        <td class="px-12 py-4 text-sm font-medium text-gray-700 whitespace-nowrap">
                                            <div class="inline-flex items-center px-3 py-1">
                                                ...
                                                <h2 class="text-sm font-normal text-gray-600">{{ $destination->name }}
                                                </h2>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        <td colspan="20">
                                            <div class="flex flex-col w-full md:max-w-sm p-4 mx-auto">
                                                ...
                                                <h1 class="mt-3 text-lg text-gray-800 text-center ">No destinations
                                                    found</h1>
                                                <div class="flex items-center my-4 sm:mx-auto gap-x-3">


                                                    <a href="{{ route('admin.destinations.create') }}"
                                                        class="flex cursor-pointer items-center md:justify-center w-1/2 px-5 py-2 text-sm tracking-wide text-white transition-colors duration-200 bg-primary rounded-lg shrink-0 sm:w-auto gap-x-2 hover:bg-primary-900">
