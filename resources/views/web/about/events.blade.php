...
@section('content')
    <div class="bg-gray-50 min-h-screen py-12">
        <div class="container mx-auto px-4">
            <h1 class="text-4xl font-bold text-blue-800 mb-10 text-center">Upcoming Events & Workshops</h1>
                ...
                <div class="bg-white shadow-lg rounded-lg overflow-hidden">
                    <div class="p-6">
                        ...
                        <div class="flex justify-between items-center">
                            ...
                            <a href="#"
                                class="bg-blue-600 text-white px-3 py-1 rounded hover:bg-blue-700 transition">Register</a>
                        </div>
                    </div>
                </div>
