    ...
    <div class="bg-gray-50 min-h-screen py-12">
        <div class="container mx-auto px-4">
            <div class="max-w-4xl mx-auto">
                <h1 class="text-4xl font-bold text-blue-800 mb-8 text-center">Career Opportunities at HAITRAC</h1>
                ...
                <div class="bg-white shadow-lg rounded-lg p-8">
                    ...
                    <div class="space-y-6">
                        <div class="border-b pb-4">
                            ...
                            <a href="#"
                                class="inline-block bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700 transition duration-300">Apply
                                Now</a>
                        </div>
                        <div class="border-b pb-4">
