...
<section class="bg-white p-5">
    <div class="container mx-auto ">
        ...
        <div class="md:p-5  space-y-5 md:max-w-6xl mx-auto md:py-5">
            ...
            <p><span class="font-bold">Posted: </span>{{ Carbon\Carbon::parse($blog->publish_date)->diffForHumans() }}</p>
            <div class="flex ">
                <img src="{{ asset('storage/images/blog/' . $blog->image) }}" class="rounded-md  object-cover" alt="{{ $blog->title }}">
            </div>
