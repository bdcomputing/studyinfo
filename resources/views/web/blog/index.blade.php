            ...
            <div class="max-w-7xl mx-auto">
                ...
                <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                    @forelse ($blogs as $blog)
                        <article class="blog-card bg-white border border-gray-100 rounded-md overflow-hidden "
                            data-category="{{ $blog->category }}">
                            <img src="{{ asset('storage/blog/' . $blog->image) }}" alt="{{ $blog->title }}"
                                class="w-full h-56 object-cover">
                            <div class="p-6">
                                <div class="flex items-center mb-4">
                                    <span class=" text-xs font-medium px-2.5 py-0.5 bg-secondary/30 rounded">
                                        {{ $blog->category }}
                                    </span>
