<nav class="fixed  top-0 left-0 right-0 z-50 bg-white border-gray-200 dark:border-gray-600 dark:bg-gray-900">
            ...
            <ul class="flex flex-col mt-4 md:flex-row md:mt-0 md:space-x-8 rtl:space-x-reverse">
                <li>
                    <a href="{{ route('web.home') }}"
                        class="block py-2 px-3 font-bold text-gray-900 border-b border-gray-100 hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-blue-500 md:dark:hover:bg-transparent dark:border-gray-700"
                        aria-current="page">Home</a>
                </li>
                <li>
                    <button id="mega-menu-full-cta-image-button" data-collapse-toggle="mega-menu-full-image-dropdown"
                        class="flex items-center font-bold justify-between w-full py-2 px-3  text-gray-900 border-b border-gray-100 md:w-auto hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-blue-600 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-blue-500 md:dark:hover:bg-transparent dark:border-gray-700">
                        About us
                ...
                <li>
                    <a href="{{ route('web.admissions') }}"
                        class="block py-2 px-3 font-bold text-gray-900 border-b border-gray-100 hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-blue-500 md:dark:hover:bg-transparent dark:border-gray-700">Admissions</a>
                </li>
    ...
    <div id="mega-menu-full-image-dropdown"
        ...
        <div
            class="grid max-w-screen-2xl px-0 py-5 mx-auto text-sm text-gray-500 dark:text-gray-400 md:grid-cols-3 md:px-6">
            <ul class="space-y-4" aria-labelledby="mega-menu-full-image-button">
                <li>
                    <a href="{{ route('web.about.mission') }}"
                        class="hover:underline text-lg hover:text-blue-600 dark:hover:text-blue-500">
                        Mission & Vision
                    </a>
                </li>
                <li>
            ...
            <ul class="space-y-4">
                ...
                <li>
                    <a href="{{ route('web.about.team') }}"
                        class="block hover:underline text-lg hover:text-blue-600 dark:hover:text-blue-500">
                        Our Team
                    </a>
                </li>
            </ul>
