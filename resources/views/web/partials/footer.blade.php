            ...
            <div class="col-span-1">
                ...
                <div class="space-y-4">
                    <div class="flex items-start">
                        <svg class="h-6 w-6 mt-0.5 mr-2 text-blue-300" xmlns="http://www.w3.org/2000/svg" fill="none"
                    ...
                    <div class="flex items-center">
                        <svg class="h-6 w-6 mr-2 text-blue-300" xmlns="http://www.w3.org/2000/svg" fill="none"
                            viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
